...
const Form = ({ dataProvinsi, setDataProvinsi }) => {
        ...
        <>
            <form onSubmit={handleSubmit}>
                <div className="my-4">
                    ...
                    <div className="">
                        <select name="provinsi" id="provinsi" className='rounded-md border-2 border-primary w-full py-2 px-2 appearance-none hover:border-primary' onChange={(e) => setProvinsi(e.target.value)}>
                ...
                <div className="mb-4">
                    ...
                    <div className="">
                        <select name="status" id="status" className='rounded-md border-2 border-primary w-full py-2 px-2 appearance-none hover:border-primary' onChange={(e) => setStatus(e.target.value)}>
                ...
                <div className="mb-7">
                    ...
                    <div className="">
                        <input type="number" name="jumlah" id="jumlah" className="rounded-md border-2 border-primary w-full py-2 px-2 hover:border-primary" placeholder='0' onChange={(e) => setJumlah(e.target.value)} required min={1} />
                    </div>
                </div>
                <div className="">
